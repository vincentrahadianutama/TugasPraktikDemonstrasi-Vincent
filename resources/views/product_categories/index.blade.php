...
<div class="container mx-auto p-6">
    ...
    <a href="{{ route('product_categories.create') }}" class="bg-orange-500 text-white px-4 py-2 rounded-md mb-4 inline-block">Add Category</a>
        ...
        <tbody>
            @foreach($categories as $category)
                <tr>
                    ...
                    <td class="px-6 py-4">
                    <a href="{{ route('product_categories.show', $category) }}" class="text-blue-500 hover:underline">View</a> |
                    <a href="{{ route('product_categories.edit', $category) }}" class="text-yellow-500 hover:underline">Edit</a> |
                    <form action="{{ route('product_categories.destroy', $category) }}" method="POST" class="inline-block">
                        @csrf
                        @method('DELETE')
